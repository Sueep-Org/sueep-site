...
/** Same always-visible, always-editable card as EmployeeBankAccountSection —
 * no "Enter manually" gate hiding it. */
export function ContractorBankAccountSection({ contractorId, initial }: Props) {
