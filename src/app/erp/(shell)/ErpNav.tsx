  ...
  return (
    ...
    >
      <path
        ...
        d="M2.25 12l8.954-8.955a1.5 1.5 0 012.122 0L22.25 12M4.5 9.75V21a.75.75 0 00.75.75H9.75v-6a1.5 1.5 0 011.5-1.5h1.5a1.5 1.5 0 011.5 1.5v6h4.5a.75.75 0 00.75-.75V9.75"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M4.5 21V4.5a.75.75 0 01.75-.75h9a.75.75 0 01.75.75V21M4.5 21h15M4.5 21H3M19.5 21H21M14.25 21v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21M7.5 7.5h1.5M7.5 11h1.5M7.5 14.5h1.5M12 7.5h1.5M12 11h1.5M15.75 3.75H19.5a.75.75 0 01.75.75V21"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3.75 6.75a2.25 2.25 0 012.25-2.25h4.19a1.5 1.5 0 011.06.44l1.62 1.62a1.5 1.5 0 001.06.44H18a2.25 2.25 0 012.25 2.25v8.25A2.25 2.25 0 0118 19.5H6a2.25 2.25 0 01-2.25-2.25V6.75z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M7 3.75h7.19a1.5 1.5 0 011.06.44l2.56 2.56a1.5 1.5 0 01.44 1.06V19.5a.75.75 0 01-.75.75H7a.75.75 0 01-.75-.75V4.5A.75.75 0 017 3.75zM9.5 12h5M9.5 15.25h5"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9 11a3 3 0 100-6 3 3 0 000 6zM2.5 20a6.5 6.5 0 0113 0M16 11a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM15 14.5c2.9.3 5.5 2.3 6 5.5"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3.5 19a5.5 5.5 0 0111 0M17.5 8v5M20 10.5h-5"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M8.25 8.25V6a1.5 1.5 0 011.5-1.5h4.5A1.5 1.5 0 0115.75 6v2.25M3 13.5h18"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6 16c.5-1.6 1.8-2.5 3-2.5s2.5.9 3 2.5M14.5 9.5h4M14.5 13h4"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M14.5 12.5l2-2M11.5 9.5l2-2M8.5 6.5l2-2M17.5 15.5l2-2"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.5 9.5a2.5 2.5 0 114.13 1.9c-.7.6-1.63 1.02-1.63 2.1M12 17h.01"
      />
    </svg>
  );
}
      ...
      {open && (
        <div className="absolute left-full top-0 z-50 pl-2">
          <div className="w-56 rounded-xl border border-gray-100 bg-white py-2 shadow-xl">
            <p className="px-3.5 pb-1.5 text-[11px] font-semibold uppercase tracking-wider text-gray-400">
              {label}
            </p>
    ...
    <div>
      ...
      >
        <span className="flex min-w-0 items-center gap-2.5">
          <Icon
            className={`h-5 w-5 shrink-0 ${groupActive ? "text-pink-600" : "text-gray-400"}`}
          />
...
export function ErpNav({ role }: { role: ErpRole }) {
  ...
  const visibleTeamItems = [...employmentGroupItems, ...teamExtraItems].filter(
    (i) => allowed(i, role),
  );
  ...
  function NavContent() {
    return (
      <>
        ...
        {showHelpCenter && (
          <NavLink item={helpCenterItem} pathname={pathname} />
        )}
      </>
    );
  }
  ...
  return (
    <>
      ...
      <aside className="hidden sm:flex w-[68px] shrink-0 flex-col items-center border-r border-gray-200 bg-white py-3">
        <Link
          href="/erp"
          className="mb-3 block shrink-0"
          aria-label="Sueep dashboard"
        >
          <Image
            src="/sueepicon.jpeg"
            alt="Sueep"
        ...
        <nav className="flex flex-1 flex-col items-center gap-1">
          ...
          {hasTeamSection && (
            <RailGroup
              label="Team"
              icon={UsersIcon}
              items={visibleTeamItems}
              pathname={pathname}
            />
          )}
          {showEstimator && (
            <RailLink item={estimatorItem} pathname={pathname} />
          )}
        </nav>
