...
export function ProjectBillingEditor({ projectId, percentInvoiced, billingStatus }: Props) {
  ...
  return (
    <form onSubmit={onSubmit} className="rounded-lg border border-gray-200 bg-gray-50 p-4">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <div>
          <label className={labelCls} htmlFor="billing-pct">
            % Invoiced
          </label>
          <input
            id="billing-pct"
        ...
        <div>
          <label className={labelCls} htmlFor="billing-status">
            Billing status
          </label>
          <select
            id="billing-status"
