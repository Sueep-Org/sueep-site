    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div id="appCanvas">
        ...
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div id="projectLoadedCard" style={{ display: "none" }}>
              ...
              <div className="flex items-start justify-between gap-3 mb-1">
                <div id="loadedProjectName" className="text-base font-semibold text-gray-900"></div>
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-sm mt-2 mb-3">
                ...
                <div>
                  <span className="text-gray-400 text-xs uppercase tracking-wide">Quotation</span>
                  <div id="loadedQuotationName" className="text-gray-700 mt-0.5">None</div>
                </div>
                <div>
            ...
            <div id="newProjectForm">
              ...
              <div className="mb-4" id="quotationInputWrapper">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Quotation File <span className="text-gray-400 font-normal">(optional)</span>
                </label>
                <input
                  type="file"
                  id="quotationInput"
            ...
            <div id="editProjectForm" style={{ display: "none" }}>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Add / Replace Quotation <span className="text-gray-400 font-normal">(optional)</span>
                </label>
                <input
                  type="file"
              ...
              <div className="flex gap-2">
                <button id="saveProjectBtn" className="px-4 py-2 bg-blue-600 text-white rounded text-sm font-medium hover:bg-blue-700">Save</button>
                <button id="cancelEditBtn" className="mini-btn">Cancel</button>
              </div>
            </div>
          </div>
          ...
          <div id="mainContent" className="hidden">
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              >
                ...
                <button id="toggleSidebarBtn" className="mini-btn" style={{ marginLeft: "auto" }}>
                  Measurements
                </button>
              </div>
          ...
          {/* QUOTATION DATA */}
          <div id="quotationDataCard" className="bg-white rounded-lg shadow-md p-6 mt-6" style={{ display: "none" }}>
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-base font-semibold text-gray-800">Quotation Data</h3>
              <span id="quotationFileName" className="text-xs text-gray-400 truncate max-w-xs"></span>
            </div>
