import { H2, P, Steps, Step, Callout, Img, SkipTo } from "@/app/erp/components/help/HelpComponents";
        ...
        <Steps>
            ...
            <Step n={2} title="Methods of Creating a Change Order">
                ...
                <ol className="mt-3 mb-3 space-y-1.5 pl-5 text-sm text-gray-700 list-decimal">
                    <li>Via the <SkipTo href="#NewProject">"New Project"</SkipTo> button</li>
            ...
            <Step n={3} title="Via the New Project Button">
                ...
                Under "Segment" select change order
